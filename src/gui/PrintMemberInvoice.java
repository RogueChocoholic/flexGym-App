...
public class PrintMemberInvoice extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PrintMemberInvoice.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                PrintMemberInvoice dialog = new PrintMemberInvoice(new javax.swing.JFrame(), true, "");
