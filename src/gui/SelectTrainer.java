...
public class SelectTrainer extends javax.swing.JDialog {
    ...
    private void loadTrainers() {
        ...
        search += " WHERE `trainer_id` LIKE '%" + trainer_id + "%' AND `fname` LIKE '%" + fname + "%' AND"
                + " `lname` LIKE '%" + lname + "%'  ";
    ...
    public SelectTrainer(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        loadTrainers();
    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Trainer ID", "Name", "Email", "Mobile", "Experience", "Specialization", "Gender"
            }
        ) {
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        String trainerId = String.valueOf(jTable1.getValueAt(row, 0));
 
        if (evt.getClickCount() == 2) {
            home.getTrainerIDTextField().setText(trainerId);
